 ...
 */
export declare enum BotlinkApiEvents {
    NewTokens = "NewTokens"
}
/**
 ...
 */
export declare enum XrdConnectionStatus {
    Connected = "Connected",
 ...
 */
export declare enum XrdVideoResolution {
 ...
 */
export declare enum XrdVideoCodec {
    Unknown = "Unknown",
    H264 = "H264",
    H265 = "H265"
}
...
export interface ApiBindings {
     ...
     */
    on(event: BotlinkApiEvents.NewTokens, callback: (tokens: {
        auth: string;
        refresh: string;
    }) => void): void;
    /**
 ...
 */
export declare enum XrdConnectionEvents {
 ...
 */
export declare enum XrdLoggerSource {
...
declare let BotlinkApi: ApiBindings;
/** C++ implementation of [[`XrdConnectionBindings`]] */
declare let XrdConnection: XrdConnectionBindings;
/** C++ implementation of [[`XrdLoggerBindings`]] */
declare let XrdLogger: XrdLoggerBindings;
